...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      /* setMessage('An error occurred while creating the complaint.'); */
    }
  };
  ...
  return (
    <div className='flex h-screen items-center justify-center'>
      <div className='w-full flex flex-col justify-start p-24'>
        <h1 className='text-[#101739] text-2xl'>Se connecter</h1>
        ...
        <div className='flex w-full justify-between items-center'>
          <Link href="/auth/forgotpassword">
            <p className='text-primary underline cursor-pointer'>Mot de passe oublié ?</p>
          </Link>
        ...
        <Spacer y={12} />
        <p className=' text-center'>vous n'avez pas un compte?
          <Link href="/auth/register" className='text-primary underline cursor-pointer ml-1'>
            Créer un compte
          </Link>
        </p>
      </div>
